...
public class RentalLogTest {
	...
	// Member variable values for assertions
		...
		public void testRentalLogWithCrud() {
			...
			//Read
			assertEquals(soc,rentalLog.getBattery().getSoc());
			assertEquals(textLocation,rentalLog.getMachine().getTextLocation());
			assertEquals(cardId,rentalLog.getBatteryUser().getCardId());
